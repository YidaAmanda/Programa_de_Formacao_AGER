...
async function seed() {
  ...
  await dataSource.query('TRUNCATE TABLE likes, comments, posts CASCADE');
  ...
  const comments = [
    {
      content: 'Excelente post! Aprendi muito com esse conteúdo.',
      author: ana,
      post: posts[0],
    },
    {
      content: 'Muito bem explicado. Vou aplicar isso no meu projeto.',
      author: marcos,
      post: posts[0],
    },
    {
      content: 'Parabéns pela clareza na explicação!',
      author: julio,
      post: posts[1],
    },
    {
      content: 'Tinha dúvidas sobre isso e você esclareceu tudo.',
      author: ana,
      post: posts[2],
    },
    {
      content: 'Conteúdo de qualidade. Continua postando!',
      author: marcos,
      post: posts[3],
    },
    {
      content: 'Que post incrível! Salvei para ler com calma.',
      author: julio,
      post: posts[4],
    },
  ];
  ...
  console.log(
    '   Usuários: julio@codeconnect.dev, ana@codeconnect.dev, marcos@codeconnect.dev (senha: senha123)',
  );
